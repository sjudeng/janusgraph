...
mvn clean install -pl janusgraph-es -Pes-docker -Delasticsearch.docker.test.version=1.7.6 -Delasticsearch.test.version=2.4.4 -Delasticsearch.test.groovy.inline="script.engine.groovy.inline.update: true" -Des.docker.image=elasticsearch
```
...
| Description | Property (Cassandrda Module) | Property (CQL Module) |
| ---- | ---- | ---- |
